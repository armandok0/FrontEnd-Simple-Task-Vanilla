import { showLoader, hideLoader, hideDeleteButton, showAddNewButton, showCreateButton, hideCreateButton } from './utilities.js';
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function displayUsers() {
        ...
        showLoader();
        hideDeleteButton();
        fetch("/app/assets/data/users.json")
            .then((response) => {
                if (!response.ok) {
    ...
    function showCreateUserForm() {
        ...
        goBackButton.innerHTML = '<img src="/app/assets/images/arrow-left.svg" alt="Go Back">';
